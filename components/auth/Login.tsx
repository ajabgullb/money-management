  ...
  return (
    <div className="min-h-[70vh] w-full flex items-center justify-center px-4">
      <div className="w-full max-w-md rounded-lg border bg-card p-6 shadow-sm">
        <h1 className="text-2xl font-semibold text-center tracking-tight mb-1">Login</h1>
        <p className="text-sm text-center text-muted-foreground mb-6">Welcome back! Please sign in to continue.</p>
